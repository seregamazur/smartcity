...
public class TransactionDaoImpl implements TransactionDao {
    ...
    @Override
    public List<Transaction> getByTaskId(Long id) {
        ...
        if (list.isEmpty()) {
            logger.error("Can't get transaction by task id = {}", id);
            throw new NotFoundException("Can't get transaction by task id =" + id);
        } else return list;
    }
