...
public class TaskDaoImpl implements TaskDao {
    ...
    public boolean delete(Long id) {
        try {
            ...
            logger.error("Can't get Task by id = {} Task Dao Delete method error: ", id, e);
            throw new NotFoundException("Delete Task Dao method error: Can't get Task by id = " + id + " " + e);
        }
        try {
            this.jdbcTemplate.update(Queries.SQL_DELETE, id);
            return true;
        } catch (Exception e) {
